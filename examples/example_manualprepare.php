...
$content = $questpass->manualPrepare(
    $originalContent,
...
<head>
  <meta charset="utf-8">
  <title>Demo page - presenting custom integration using Questpass PHP-SDK</title>
  ...
  <div class="container">
    <div class="row">
      <div class="twelve column" style="margin-top: 5%">
        <h4>Demo page - presenting custom integration using Questpass PHP-SDK</h4>
        <?php echo $content; ?>
      </div>
    </div>
  </div>
